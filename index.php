  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">WA-CHAT OOP</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <center><h5 class="mt-5"><strong>Wa-Chat OOP</strong></h5></center>
       <center><b>"Wa-Chat OOP, Atau WhatsApp Direct Link Adalah Pembuat Link Chat"</b></center>
                </div>
              </div>
            </div>
          </div>
